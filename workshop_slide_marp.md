...
paginate: true
math: mathjax
footer: 'Context & Framing Sensitivity — R&D Management Workshop 2026'
---

<!-- Export: npx -y @marp-team/marp-cli workshop_slide_marp.md -o workshop.pptx -->
...
| **DS** (Decision stability) | Repeatability across reruns | $1 - H(p)/\log_2\lvert\mathcal{A}\rvert$ |
