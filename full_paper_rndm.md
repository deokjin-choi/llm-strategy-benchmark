...
$$
CR(m,\tau)=E_{s,\phi,\,v\in\mathcal{V}_{\mathrm{sem}}}\Big[JSD\big(P(m,\tau,s,\text{Base},\phi),\,P(m,\tau,s,v,\phi)\big)\Big]
$$
...
$$
p_{c}^{m,\tau}(a)=\frac{1}{R}\sum_{r=1}^{R}1[\text{strategy}_{r}=a],\quad a\in\mathcal{A}.
$$
