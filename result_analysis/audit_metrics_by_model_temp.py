...
Mean context TVD and mean firm-identity max |Δp| use audit_localization_metrics
(max TVD over perturbation variants including randomized_numbers; max |Δp| over
